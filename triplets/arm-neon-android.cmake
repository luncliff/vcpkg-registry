...
Customized triplet to build NDK(armeabi-v7a) after NDK 24
...
if(NDK_VERSION_OVER_21)
    ...
    find_file(NDK_VULKAN_LIB_PATH NAME libvulkan.so
        PATHS $ENV{VULKAN_SDK}/lib/arm-linux-android/${NDK_API_LEVEL}
              $ENV{VULKAN_SDK}/lib/arm-linux-androideabi/${NDK_API_LEVEL}
    )
else()
    # If your API level is 30, libvulkan.so is at 
