...
Customized triplet to build NDK(x86_64)
...
if(NDK_VERSION_OVER_21)
    ...
    #  $ENV{ANDROID_NDK_HOME}/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/x86_64-linux-android/30
    find_file(NDK_VULKAN_LIB_PATH NAME libvulkan.so
        PATHS $ENV{VULKAN_SDK}/lib/x86_64-linux-android/${NDK_API_LEVEL}
    )
else()
    # If your API level is 30, libvulkan.so is at 
    #  $ENV{ANDROID_NDK_HOME}/platforms/android-30/arch-x86_64/usr/lib
    find_file(NDK_VULKAN_LIB_PATH NAME libvulkan.so
        PATHS $ENV{ANDROID_NDK_HOME}/platforms/android-${NDK_API_LEVEL}/arch-x86_64/usr/lib64/
    )
endif()
