...
message(STATUS "Using NDK: ${NDK_DIR_NAME} ${NDK_MAJOR_VERSION} ${NDK_MINOR_VERSION}")
...
if(NDK_VERSION_OVER_21)
    ...
    get_filename_component(NDK_VULKAN_LIB_PATH $ENV{VULKAN_SDK}/lib/aarch64-linux-android/${NDK_API_LEVEL}/libvulkan.so ABSOLUTE)
else()
    # If your API level is 30, libvulkan.so is at 
