...
set(DYNOLOG_REF "75e2715e2241b0e72891ea5d9f2ec84b781d49ce")
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DDYNOLOG_GIT_REV=${DYNOLOG_REF}
        # -DWITH_GFLAGS=ON
        -DUSE_PROMETHEUS=ON # prometheus-cpp
        -DUSE_OTEL=ON # opentelemetry-cpp
        -DUSE_OTLP=OFF # curl
        -DUSE_ODS_GRAPH_API=OFF # cpr
        -DUSE_K8S_PODRESOURCES=ON # need more detailed check
        -DBUILD_TESTS=OFF
)
vcpkg_cmake_install()
