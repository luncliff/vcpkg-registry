...
vcpkg_from_github(
    ...
    REF v${VERSION}
    SHA512 7983866adeceddd7c867d14f9bd40df899ead255214aea5a1ce62b2b39ddfb602b6f2e3efa6572893d2d472916e0d2206f4cd404094ef49a85ce5b3294e23748
    PATCHES
...
set(TFLITE_ENABLE_XNNPACK_VALUE ON)
if(VCPKG_TARGET_IS_WINDOWS)
    # Avoid XNNPACK experimental APIs that are missing in the current port build.
    set(TFLITE_ENABLE_XNNPACK_VALUE OFF)
endif()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DTFLITE_ENABLE_XNNPACK=${TFLITE_ENABLE_XNNPACK_VALUE}
